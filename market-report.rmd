---
title: "R+port"
date: '`r paste0("(GMT+9) ",format(Sys.Date(),tz = "Asia/Seoul"))`'
author: Allen park
...
dfc[1,7] = ifelse((length(market_intra(cmm[1])[[1]]) >= 1350) & (tail(market_intra(cmm[1])[[1]],n=1) >= "04:59"),"CLOSE","OPEN")

dfc[2,7] = ifelse((length(market_intra(cmm[2])[[1]]) >= 1350) & (tail(market_intra(cmm[2])[[1]],n=1) >= "04:59"),"CLOSE","OPEN")
