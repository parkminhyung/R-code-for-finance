...
row.names(dfw) = NULL
  ...
  for (i in 1:3) dfw[i,8] = ifelse(tail(market_intra(us[i])[[1]],n=1) >= "15:59:00","CLOSE","OPEN")
dfw[4,8] = ifelse(length(market_intra(eu[1])[[1]]) %in% c("515","516"),"CLOSE","OPEN")
  ...
  for (i in 7:8) dfw[i,8] = ifelse(tail(market_intra(cn[i-6])[[1]],n=1) >= "14:59","CLOSE","OPEN")
